...
implements AuthenticationPlugin<NativePacketPayload> {
    ...
    public boolean nextAuthenticationStep(NativePacketPayload fromServer, List<NativePacketPayload> toServer) {
        ...
        if (fromServer == null || pwd == null || pwd.length() == 0) {
            ...
            packet = new NativePacketPayload(StringUtils.getBytes(MysqlOldPasswordPlugin.newCrypt(pwd, fromServer.readString(NativeConstants.StringSelfDataType.STRING_TERM, null).substring(0, 8), this.protocol.getServerSession().getCharsetSettings().getPasswordCharacterEncoding())));
