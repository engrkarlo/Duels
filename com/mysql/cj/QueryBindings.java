...
public interface QueryBindings {
    ...
    public void setBindValues(BindValue[] var1);
    ...
    public void setLongParameterSwitchDetected(boolean var1);

    public AtomicBoolean getSendTypesToServer();

    public BindValue getBinding(int var1, boolean var2);

    public void setFromBindValue(int var1, BindValue var2);
    ...
    public void setBytes(int var1, byte[] var2, boolean var3);
    ...
    public void setTimestamp(int var1, Timestamp var2, Calendar var3, Field var4, MysqlType var5);
