...
import com.ultimateduels.libs.hikari.HikariConfigMXBean;
...
implements HikariConfigMXBean {
    ...
    private static final long SOFT_TIMEOUT_FLOOR = Long.getLong("com.ultimateduels.libs.hikari.timeoutMs.floor", 250L);
    ...
    private String generatePoolName() {
        ...
        try {
            ...
            synchronized (properties) {
                String next = String.valueOf(Integer.getInteger("com.ultimateduels.libs.hikari.pool_number", 0) + 1);
                System.setProperty("com.ultimateduels.libs.hikari.pool_number", next);
