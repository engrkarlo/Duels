...
public class Constants {
    ...
    public static final String CJ_FULL_NAME = "mysql-connector-j-8.3.0";
    public static final String CJ_REVISION = "805f872a57875f311cb82487efcfb070411a3fa0";
    public static final String CJ_VERSION = "8.3.0";
    public static final String CJ_MAJOR_VERSION = "8";
    public static final String CJ_MINOR_VERSION = "3";
