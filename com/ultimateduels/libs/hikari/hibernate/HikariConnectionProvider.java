 ...
 */
package com.ultimateduels.libs.hikari.hibernate;

import com.ultimateduels.libs.hikari.HikariConfig;
import com.ultimateduels.libs.hikari.HikariDataSource;
import com.ultimateduels.libs.hikari.hibernate.HikariConfigurationUtil;
...
Stoppable {
    ...
    public HikariConnectionProvider() {
        if (Version.getVersionString().substring(0, 5).compareTo("4.3.6") >= 1) {
            LOGGER.warn("com.ultimateduels.libs.hikari.hibernate.HikariConnectionProvider has been deprecated for versions of Hibernate 4.3.6 and newer.  Please switch to org.hibernate.hikaricp.internal.HikariCPConnectionProvider.");
        }
    }
