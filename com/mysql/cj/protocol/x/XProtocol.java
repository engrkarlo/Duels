...
implements Protocol<XMessage> {
    ...
    public void negotiateCompression() {
        ...
        String[] compressionAlgorithmsOrder = (String[])((Stream)Arrays.stream(compressionAlgsOrder).sequential()).filter(n -> n != null && !n.isEmpty()).map(String::toLowerCase).map(CompressionAlgorithm::getNormalizedAlgorithmName).toArray(String[]::new);
    ...
    private Map<String, String> getConnectionAttributesMap(String attStr) {
        ...
        attMap.put("_client_version", "8.3.0");
