...
import com.ultimateduels.libs.hikari.SQLExceptionOverride;
...
import com.ultimateduels.libs.hikari.util.DriverDataSource;
import com.ultimateduels.libs.hikari.util.PropertyElf;
...
abstract class PoolBase {
    ...
    private static final int MINIMUM_LOGIN_TIMEOUT = Integer.getInteger("com.ultimateduels.libs.hikari.minimumLoginTimeoutSecs", 1);
    ...
    void handleMBeans(HikariPool hikariPool, boolean register) {
        ...
        try {
            ...
            if ("true".equals(System.getProperty("hikaricp.jmx.register2.0"))) {
                beanConfigName = new ObjectName("com.ultimateduels.libs.hikari:type=PoolConfig,name=" + this.poolName);
                beanPoolName = new ObjectName("com.ultimateduels.libs.hikari:type=Pool,name=" + this.poolName);
            } else {
                beanConfigName = new ObjectName("com.ultimateduels.libs.hikari:type=PoolConfig (" + this.poolName + ")");
                beanPoolName = new ObjectName("com.ultimateduels.libs.hikari:type=Pool (" + this.poolName + ")");
            }
            if (register) {
    ...
    private void createNetworkTimeoutExecutor(DataSource dataSource, String dsClassName, String jdbcUrl) {
        if (dsClassName != null && dsClassName.contains("Mysql") || jdbcUrl != null && jdbcUrl.contains("mysql") || dataSource != null && dataSource.getClass().getName().contains("Mysql")) {
            ...
            threadFactory = threadFactory != null ? threadFactory : new UtilityElf.DefaultThreadFactory(this.poolName + " network timeout executor");
