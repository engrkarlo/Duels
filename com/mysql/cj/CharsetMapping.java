...
public class CharsetMapping {
    ...
    static {
        ...
        for (int i = 1; i < 1024; ++i) {
            ...
            CharsetMapping.COLLATION_INDEX_TO_COLLATION_NAME[i] = coll.collationNames[0];
            collationIndexToCharset.put(i, coll.mysqlCharset);
            String[] stringArray = coll.collationNames;
            int n = stringArray.length;
            for (int j = 0; j < n; ++j) {
                String collationName = stringArray[j];
        ...
        for (MysqlCharset cs : charset) {
            Integer idx;
            if (cs.aliases.isEmpty() || (idx = (Integer)charsetNameToCollationIndexMap.get(cs.charsetName)) == null) continue;
