...
def patch_lobby_spawn_initialization(text):
    old = '''            Location lobbySpawn;\n            if (!player.isOnline()) {'''
    new = '''            Location lobbySpawn = null;\n            if (!player.isOnline()) {'''
    return replace_once(text, old, new, 'com/ultimateduels/listeners/PlayerJoinQuitListener.java')
...
edit('com/ultimateduels/listeners/PlayerJoinQuitListener.java', patch_lobby_spawn_initialization)
